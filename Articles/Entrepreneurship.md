...
* (2024) Ultimate Plan: Hotels (pricing and location), airports, and tourist attractions, all on the map. Plus actual routes for the actual travel. (Can be part of Gravity network) (idea from) Planning traveling with Google Map, Google Earth, Booking, Expedia is VERY inconvinient.
